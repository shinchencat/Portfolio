...
function insertbodyBN(blockNumFirst1, blockNumLast1, targetDom){
	...
	function inHtml() {
		newArr.forEach(function (item) {
			html += `
			<div class="col-4  hoversacle px-1 px-xl-2"><a href="`+ item.Link.Url +`" target="_blank"><img
...
window.onload = function() {
	...
	// 強打輪播
   //insertMainSlider(53,62, '#mainSlider ul');
	// 第二個輪播
	...
	insertPD(31,40, '#pd_01');
	insertPD(42,51, '#pd_02');
	insertPD(53,62, '#pd_03');
	insertPD(64,73, '#pd_04');
};